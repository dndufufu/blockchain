...
func CmdListCohort() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "list-cohort",
		Short: "list all cohort",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			params := &types.QueryAllCohortRequest{
				Pagination: pageReq,
			}

			res, err := queryClient.CohortAll(context.Background(), params)
			if err != nil {
				return err
			}
...
func CmdShowCohort() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "show-cohort [id]",
